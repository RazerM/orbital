...
class ImpulseOperation(Operation):
    ...
    def velocity_delta(self):
        ...
        raise NotImplementedError(
            f"Subclasses of {__name__}.{__class__.__name__} must implement {self.velocity_delta.__name__}"
        )
...
class TimeOperation(Operation):
    ...
    def time_delta(self, orbit):
        ...
        """
        raise NotImplementedError(
            f"Subclasses of {__name__}.{__class__.__name__} must implement {self.time_delta.__name__}"
        )
...
class SetApocenterRadiusTo(ReprHelperMixin, ImpulseOperation):
    ...
    def __apply__(self, orbit):
        a, e = elements_for_apsides(self.apocenter_radius, orbit.pericenter_radius)
        orbit.a = a
        orbit.e = e
    ...
    def __plot__(self, orbit, plotter, next_operation=None):
        ...
        with saved_state(orbit):
            if next_operation is not None and isinstance(next_operation, TimeOperation):
...
class SetApocenterAltitudeTo(ReprHelperMixin, ImpulseOperation):
    ...
    def __apply__(self, orbit):
        ...
        a, e = elements_for_apsides(apocenter_radius, orbit.pericenter_radius)
        orbit.a = a
        orbit.e = e
...
class ChangeApocenterBy(ReprHelperMixin, ImpulseOperation):
    ...
    def __apply__(self, orbit):
        a, e = elements_for_apsides(
            orbit.apocenter_radius + self.delta, orbit.pericenter_radius
        )
        orbit.a = a
        orbit.e = e
...
class SetPericenterRadiusTo(ReprHelperMixin, ImpulseOperation):
    ...
    def __apply__(self, orbit):
        a, e = elements_for_apsides(orbit.apocenter_radius, self.pericenter_radius)
        orbit.a = a
        orbit.e = e
...
class SetPericenterAltitudeTo(ReprHelperMixin, ImpulseOperation):
    ...
    def __apply__(self, orbit):
        ...
        a, e = elements_for_apsides(orbit.apocenter_radius, pericenter_radius)
        orbit.a = a
        orbit.e = e
...
class ChangePericenterBy(ReprHelperMixin, ImpulseOperation):
    ...
    def __apply__(self, orbit):
        a, e = elements_for_apsides(
            orbit.apocenter_radius, orbit.pericenter_radius + self.delta
        )
        orbit.a = a
        orbit.e = e
...
class PropagateAnomalyTo(ReprHelperMixin, TimeOperation):
    ...
    def __plot__(self, orbit, plotter, next_operation=None):
        ...
        plotter._plot_position(orbit, orbit.f, propagated=True)
...
class Maneuver(ReprHelperMixin):
    ...
    def set_apocenter_radius_to(cls, apocenter_radius):
        ...
        operations = [PropagateAnomalyTo(M=0), SetApocenterRadiusTo(apocenter_radius)]
    ...
    def change_apocenter_by(cls, delta):
        ...
        operations = [PropagateAnomalyTo(M=0), ChangeApocenterBy(delta)]
        return cls(operations)

    @classmethod
    def change_pericenter_by(cls, delta):
        """Maneuver for changing pericenter."""
        operations = [PropagateAnomalyTo(M=pi), ChangePericenterBy(delta)]
        return cls(operations)
    ...
    def __apply__(self, orbit):
        for operation in self.operations:
            ...
            if hasattr(operation, "__apply__") and callable(
                getattr(operation, "__apply__")
            ):
