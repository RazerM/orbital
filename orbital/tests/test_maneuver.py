...
class TestOperation(unittest.TestCase):
    ...
    def test_set_apside_radii(self):
        ...
        self.assertAlmostEqual(self.LEO.apocenter_radius, set_apocenter.apocenter_radius)
        ...
        self.assertAlmostEqual(self.LEO.pericenter_radius, set_pericenter.pericenter_radius)
        self.assertAlmostEqual(self.LEO.apocenter_radius, set_apocenter.apocenter_radius)
    ...
    def test_change_apsides(self):
        ...
        self.LEO.propagate_anomaly_to(M=0)
        self.LEO.apply_maneuver(set_apocenter)
        self.assertAlmostEqual(old_apocenter_radius + set_apocenter.delta, self.LEO.apocenter_radius)
        ...
        self.LEO.apply_maneuver(set_pericenter)
        self.assertAlmostEqual(old_apocenter_radius + set_apocenter.delta, self.LEO.apocenter_radius)
        self.assertAlmostEqual(old_pericenter_radius + set_pericenter.delta, self.LEO.pericenter_radius)
